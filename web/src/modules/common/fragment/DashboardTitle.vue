...
<template>
  <div class="p-h-10 b-b f-18" :style="styleObj" flex="cross:center">
    <cc-icon flex-box="0" class="m-r-10" v-if="dashboard.icon" :name="dashboard.icon"></cc-icon>
    <span flex-box="1" class="p-v-8">{{dashboard.name}}</span>
