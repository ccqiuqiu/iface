...
INSERT INTO `menu` VALUES ('16cb2bbb-483b-476e-b884-55200501db7d', 'test', '/baseData/page/test2', NULL, 4, 'd1f40cb0-d59d-47c2-ae24-b2bc4d1b344f', 'd1f40cb0-d59d-47c2-ae24-b2bc4d1b344f', 'd1f40cb0-d59d-47c2-ae24-b2bc4d1b344f.16cb2bbb-483b-476e-b884-55200501db7d.', '2019-07-04 17:00:54.062115', '2019-07-04 17:01:32.000000', 1);
...
INSERT INTO `menu` VALUES ('2c9dfd6a-7d69-4c59-a1a4-1931f19c40ee', '资源包管理', '/system/resBag', NULL, 11, 'd19c4517-37ad-4496-bce6-f62fdc5aeebd', 'd19c4517-37ad-4496-bce6-f62fdc5aeebd', '2c9dfd6a-7d69-4c59-a1a4-1931f19c40ee.', '2019-07-16 08:33:25.647704', '2019-07-16 08:33:30.000000', 1);
...
INSERT INTO `menu` VALUES ('49d9ae31-fe6d-4c90-9684-b75e6b80303a', '我的产品', '/system/myProduct', NULL, 13, 'd19c4517-37ad-4496-bce6-f62fdc5aeebd', 'd19c4517-37ad-4496-bce6-f62fdc5aeebd', '49d9ae31-fe6d-4c90-9684-b75e6b80303a.', '2019-07-17 10:28:51.323811', '2019-07-17 10:28:51.000000', 1);
...
INSERT INTO `menu` VALUES ('d2d666c7-1672-4bf9-909e-557e480ec24b', '产品管理', '/system/product', NULL, 12, 'd19c4517-37ad-4496-bce6-f62fdc5aeebd', 'd19c4517-37ad-4496-bce6-f62fdc5aeebd', 'd2d666c7-1672-4bf9-909e-557e480ec24b.', '2019-07-12 14:48:36.872000', '2019-07-16 08:33:30.000000', 1);
...
-- ----------------------------
BEGIN;
INSERT INTO `page` VALUES ('09bf1fd2-8254-4f61-b9b9-22c5b45f3a90', '资源管理', 1, 'resource', 'system/resource', '{\"title\":\"资源管理\",\"name\":\"system/resource\",\"items\":[{\"label\":\"名称\",\"prop\":\"name\",\"multiSelect\":false,\"placeholder\":\"请输入资源名称\",\"target\":[\"searchForm\",\"editForm\",\"table\",\"view\"],\"verify\":{\"required\":true,\"maxLength\":32},\"formProps\":{\"type\":\"text\"}},{\"label\":\"请求方法\",\"prop\":\"method\",\"target\":[\"editForm\",\"searchForm\",\"table\",\"view\"],\"multiSelect\":false,\"formProps\":{\"type\":\"select\",\"options\":\"methods\"}},{\"label\":\"URL\",\"prop\":\"url\",\"multiSelect\":false,\"target\":[\"searchForm\",\"editForm\",\"table\",\"view\"],\"placeholder\":\"请输入资源URL\",\"verify\":{\"required\":true,\"maxLength\":64},\"formProps\":{\"type\":\"text\"}},{\"label\":\"创建时间\",\"prop\":\"addTime\",\"target\":[\"editForm\",\"searchForm\",\"table\",\"view\"],\"multiSelect\":false,\"formProps\":{\"type\":\"text\"}}],\"searchForm\":{\"model\":{}},\"editForm\":{\"model\":{}},\"table\":{\"rows\":[]}}', '', '', '', '资源管理页面', '2018-07-24 14:44:57.797222', '2019-07-22 16:08:55.000000', '');
...
INSERT INTO `page` VALUES ('66ca46ad-fbf0-4594-8727-08e0345a21c4', '用户管理', 1, 'user', 'system/user', '{\"title\":\"用户管理\",\"name\":\"system/user\",\"items\":[{\"label\":\"名称\",\"prop\":\"userName\",\"placeholder\":\"请输入用户名\",\"target\":[\"searchForm\",\"editForm\",\"table\",\"view\"],\"verify\":{\"required\":true,\"maxLength\":64},\"formProps\":{\"type\":\"text\"},\"multiSelect\":false},{\"label\":\"密码\",\"prop\":\"password\",\"target\":[\"editForm\"],\"placeholder\":\"请输入密码\",\"verify\":{\"required\":true,\"maxLength\":32},\"formProps\":{\"type\":\"text\"},\"multiSelect\":false},{\"label\":\"电话\",\"prop\":\"tel\",\"multiSelect\":false,\"target\":[\"searchForm\",\"editForm\",\"table\",\"view\"],\"placeholder\":\"请输入电话号码\",\"formProps\":{\"type\":\"text\"}},{\"label\":\"性别\",\"target\":[\"searchForm\",\"editForm\",\"table\",\"view\"],\"prop\":\"sex\",\"formProps\":{\"type\":\"select\",\"options\":\"sex\"},\"multiSelect\":false,\"verify\":{\"required\":true}},{\"label\":\"角色\",\"prop\":\"roleIds\",\"target\":[\"table\",\"view\",\"editForm\"],\"multiSelect\":true,\"formProps\":{\"type\":\"tree\",\"props\":{\"check-strictly\":true},\"options\":\"roleTree\"}},{\"label\":\"状态\",\"prop\":\"status\",\"target\":[\"searchForm\",\"editForm\",\"table\",\"view\"],\"formProps\":{\"type\":\"select\",\"options\":\"status\"},\"multiSelect\":false,\"verify\":{\"required\":true}}],\"searchForm\":{\"model\":{}},\"editForm\":{\"model\":{}},\"table\":{\"rows\":[]}}', NULL, NULL, NULL, '用户管理的页面', '2018-07-24 14:44:57.797222', '2019-07-22 12:05:32.000000', NULL);
...
INSERT INTO `resource` VALUES ('1022053d-c5a4-4b65-94d1-c048eed04266', 'ee 删除', 'DELETE', 'aaaaa/*', 2, '2019-07-04 17:00:19.312071', '2019-07-04 17:00:19.312071');
INSERT INTO `resource` VALUES ('1b63c15a-1ade-4976-86fc-671613c34da6', 'ee 搜索', 'GET', 'aaaaa', 2, '2019-07-04 17:00:19.312071', '2019-07-04 17:00:19.312071');
...
INSERT INTO `resource` VALUES ('310f0a7b-f4a3-44ae-ab8a-fcc75aa71882', '资源管理 详情', 'GET', 'system/resource/*', 2, '2019-07-22 16:08:55.211994', '2019-07-22 16:08:55.211994');
...
INSERT INTO `resource` VALUES ('3bcd9c97-6f9f-4296-bce6-cbaf4426b210', '用户管理 保存', 'PUT', 'system/user', 2, '2019-07-22 12:05:32.904840', '2019-07-22 12:05:32.904840');
...
INSERT INTO `resource` VALUES ('43790436-aa75-4b6c-83f4-c20d2e8e1978', 'test2 删除', 'DELETE', 'ddffsfs/*', 2, '2019-07-04 17:06:12.956107', '2019-07-04 17:06:12.956107');
...
INSERT INTO `resource` VALUES ('67744438-4b78-4fcf-8952-94be6c54cccb', '用户管理 详情', 'GET', 'system/user/*', 2, '2019-07-22 12:05:32.904840', '2019-07-22 12:05:32.904840');
INSERT INTO `resource` VALUES ('8980ed7a-a9b1-4480-bf3a-5f5941a0b1d7', 'test2 详情', 'GET', 'ddffsfs/*', 2, '2019-07-04 17:06:12.956107', '2019-07-04 17:06:12.956107');
INSERT INTO `resource` VALUES ('899e33f0-2cf5-40ea-aac4-92f0849b489d', 'test2 保存', 'PUT', 'ddffsfs', 2, '2019-07-04 17:06:12.956107', '2019-07-04 17:06:12.956107');
...
INSERT INTO `resource` VALUES ('974bb012-00c1-41ae-b535-ab0b471303fc', 'ee 详情', 'GET', 'aaaaa/*', 2, '2019-07-04 17:00:19.312071', '2019-07-04 17:00:19.312071');
...
INSERT INTO `resource` VALUES ('adff26e1-db9a-4c7f-b6b2-8f43302f1402', '资源管理 保存', 'PUT', 'system/resource', 2, '2019-07-22 16:08:55.211994', '2019-07-22 16:08:55.211994');
INSERT INTO `resource` VALUES ('b249d358-3a7c-4dd0-9b4f-315a3aade750', 'test2 搜索', 'GET', 'ddffsfs', 2, '2019-07-04 17:06:12.956107', '2019-07-04 17:06:12.956107');
INSERT INTO `resource` VALUES ('b63190ed-9e9b-416a-a746-4dc54452242b', '用户管理 搜索', 'GET', 'system/user', 2, '2019-07-22 12:05:32.904840', '2019-07-22 12:05:32.904840');
INSERT INTO `resource` VALUES ('cd83c3a6-ec85-4ae6-9787-13709cb6f139', '资源管理 删除', 'DELETE', 'system/resource/*', 2, '2019-07-22 16:08:55.211994', '2019-07-22 16:08:55.211994');
...
INSERT INTO `resource` VALUES ('d783b35f-7f59-457a-8832-260c10f7fa85', '用户管理 删除', 'DELETE', 'system/user/*', 2, '2019-07-22 12:05:32.904840', '2019-07-22 12:05:32.904840');
INSERT INTO `resource` VALUES ('d9e2ba2c-3280-4a96-8ae5-cc6481fe30db', '资源管理 搜索', 'GET', 'system/resource', 2, '2019-07-22 16:08:55.211994', '2019-07-22 16:08:55.211994');
...
INSERT INTO `resource` VALUES ('fa8c398b-5fa1-4a4b-ac58-a50ed2c43cea', 'ee 保存', 'PUT', 'aaaaa', 2, '2019-07-04 17:00:19.312071', '2019-07-04 17:00:19.312071');
COMMIT;
